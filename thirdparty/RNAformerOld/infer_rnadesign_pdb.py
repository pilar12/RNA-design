...
from eval_predictions import evaluate, print_dict_tables, mat2pairs
import glob
...
if __name__ == '__main__':
    ...
    file = "/work/dlclarge2/patilsh-aptamer-design/aptamer-design/runs/pdb_ft/version_2/predictions_100_dp/"
    dataset_type = "model_infer"
    pred_files = glob.glob(file+"**.pt")
    for pred_file in pred_files:
        pred_file = pred_file.split("/")[-1]
        struct_file = file+pred_file[:-3]+"_structs.pt"
        if os.path.exists(struct_file):
            ...
            if dataset_type == "model_infer":
                for sample in tqdm.tqdm(dataset):
                    ...
                    pred_mat = [mat2pairs(mat) for mat in pred_mat]
